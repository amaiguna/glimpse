...
| # | Title | Status | 概要 |
|---|---|---|---|
| 001 | [Filtered Grep モードの追加](001-filtered-grep.md) | In Progress | 既存 Grep モードにファイル絞り込み (glob) 入力欄を追加。Phase 1 (#006 Pane 分割) + Phase 2 (UI) 完了 2026-05-01。残 Phase 3-4 (rg --glob 配線、ポリッシュ)。 |
